...
public class PDFReader : MonoBehaviour 
{
	...
	public static bool AutoCache { get { return _autoCache; } set { _autoCache = value; }}
	public static float NavbarOffsetY { get { return _navbarOffsetY; } set { _navbarOffsetY = value; }}
	#endregion

	#region PRIVATE_VARIABLES
	private static bool _autoCache;
	private static float _navbarOffsetY = 0f;
	#endregion
	
	[DllImport("__Internal")]
	private static extern void OpenDocumentInMenu(string docPath, bool onlyThirdPartyApp, Anchor anchor);
	[DllImport("__Internal")]
	private static extern void OpenDocumentInWebViewLocal(string docPath, string docTitle, string backTitle, bool share, float navbarOffsetY);
	[DllImport("__Internal")]
	private static extern void OpenDocumentInWebViewLocalWithCallback(string docPath, string docTitle, string backTitle, bool share, string goName, string callbackMethod, float navbarOffsetY);
	[DllImport("__Internal")]
	private static extern void OpenDocumentInWebViewRemote(string docTitle, string docRemoteURL, string backTitle, bool share, float navbarOffsetY);
	[DllImport("__Internal")]
	private static extern void OpenDocumentInWebViewRemoteWithCallback(string docTitle, string docRemoteURL, string backTitle, bool share, string goName, string callbackMethod, float navbarOffsetY);
	[DllImport("__Internal")]
	private static extern void OpenDocumentCG(string docPath, int from, int to, string rect, float navbarOffsetY);
	[DllImport("__Internal")]
	private static extern void OpenDocumentCGWithCallback(string docPath, int from, int to, string rect, string goName, string callbackMethod, float navbarOffsetY);
	[DllImport("__Internal")]
	private static extern void OpenHTML(string docPath, string navbarTitle, float navbarOffsetY);
	[DllImport("__Internal")]
	private static extern bool CacheData(string docRemoteURL);
	[DllImport("__Internal")]
	private static extern bool IsCached(string docRemoteURL);
	[DllImport("__Internal")]
	private static extern void SetWebViewContentOffset(int page, string docPath);
	...
	{
		OpenDocumentInWebViewLocal(docPath, docTitle, backTitle, share, _navbarOffsetY);
	}
	...
	{
		OpenDocumentInWebViewLocalWithCallback(docPath, docTitle, backTitle, share, goName, callbackMethod, _navbarOffsetY);
	}
	...
	public static void OpenDocInWebViewRemote(string docTitle, string docRemoteURL, string backTitle = "Back", bool share = false)
	{
		...
		OpenDocumentInWebViewRemote(docTitle, docRemoteURL, backTitle, share, _navbarOffsetY);
	}
	...
	public static void OpenDocInWebViewRemote(string docTitle, string docRemoteURL, string backTitle, string goName, string callbackMethod, bool share = false)
	{
		if(_autoCache)
			CacheData(docRemoteURL);
		OpenDocumentInWebViewRemoteWithCallback(docTitle, docRemoteURL, backTitle, share, goName, callbackMethod, _navbarOffsetY);
	}
	...
	public static void OpenDocCG(string docPath, int from = -7, int to = 0, string rect = "")
	{
		...
		OpenDocumentCG(docPath, from, to, rect, _navbarOffsetY);
	}
	public static void OpenDocCG(string docPath, string goName, string callbackMethod, int from = -7, int to = 0, string rect = "")
	{
		if(string.IsNullOrEmpty(rect))
			rect = "0,0," + Screen.width.ToString() + "," + Screen.height.ToString();
		OpenDocumentCGWithCallback(docPath, from, to, rect, goName, callbackMethod, _navbarOffsetY);
	}
	public static void OpenHTMLLocal(string docPath, string navbarTitle)
	{
		OpenHTML(docPath, navbarTitle, _navbarOffsetY);
	}
	/// <summary>
	...
	public static void SetWebviewPageOffset(int page, string docPath)
	{
		SetWebViewContentOffset(page, docPath);			
	}
